...
class CollectTrainingData(object):
    def __init__(self):
        ...
        self.server_socket.bind(('192.168.43.152', 8000))
                    ...
                    for event in pygame.event.get():
                        if event.type == KEYDOWN:
                            ...
                            if keypress == pygame.K_LEFT:
                                print 'left'
                                urllib2.urlopen('http://192.168.43.141:5000/left').read()
                                ...
                                print 'right'
                                urllib2.urlopen('http://192.168.43.141:5000/right').read()
                                image_array = np.vstack((image_array, temp_image_array))
                                ...
                                print 'forward'
                                urllib2.urlopen('http://192.168.43.141'
                                                ':5000/forward').read()
                                image_array = np.vstack((image_array, temp_image_array))
